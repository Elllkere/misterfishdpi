...
namespace vars
{
    ...
    {
        {providers_list::PROVIDER_OTHER, "Другой"},
        {providers_list::PROVIDER_ROST, "Ростелеком"},
        {providers_list::PROVIDER_MTS, "МТС"},
        {providers_list::PROVIDER_LOVIT, "Lovit"}
    };

    std::map<int, std::string> auto_starts =
    {
        {0, "Планировщик задач (с вкл. UAC)"},
        {1, "Реестр (с выкл. UAC)"},
        {2, "Пользовательский"},
    };
    ...
    std::string version = "v25.1228.0237";
